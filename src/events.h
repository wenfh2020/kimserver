...
class Events {
   ...
   private:
    static void on_event_callback(struct ev_loop* loop, struct ev_io* e, int events);
    static void on_signal_callback(struct ev_loop* loop, struct ev_signal* watcher, int revents);
